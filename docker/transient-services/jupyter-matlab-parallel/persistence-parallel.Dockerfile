# Image name: jupyter_matlab_parallel -> based on snj-base-lab-persistence
...
FROM harbor.cloud.infn.it/datacloud-templates/snj-base-lab-persistence:1.2.0 AS base_jupyter_image

# Base Jupyter image with LICENSE_SERVER
FROM harbor.cloud.infn.it/datacloud-templates/snj-base-lab-persistence:1.2.0 AS base_jupyter_image_with_lm
ARG LICENSE_SERVER
